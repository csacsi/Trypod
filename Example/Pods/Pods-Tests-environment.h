...
// UsefullLibrary
#define COCOAPODS_POD_AVAILABLE_UsefullLibrary
#define COCOAPODS_VERSION_MAJOR_UsefullLibrary 0
#define COCOAPODS_VERSION_MINOR_UsefullLibrary 1
#define COCOAPODS_VERSION_PATCH_UsefullLibrary 0
